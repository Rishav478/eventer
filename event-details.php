				...
				<div class="row">
					...
					<div class="col-md-5 col-md-push-2">
						<div id="product-main-img">
							<div class="product-details">
								<img style="height: 300px" src="seller/assets/uploads/event-banner/<?= $row['event_banner'] ?>" alt="<?= $row['event_banner'] ?>">
							</div>
						</div>
					</div>
					<!-- /Product main img -->
					...
					<div class="col-md-5">
						<div class="product-details"><br>
							...
							<p>Organizer: <strong><a href="about-org.php?name=<?= $sellerId ?>"><?= $rs['orgName'] ?></a></strong></p>
							<div>
								...
								<span>Event Type: <?php if($row['virtual_event'] == 'yes'){echo "<b>VIRTUAL EVENT</b>";}else{echo "<b>OFFLINE EVENT</b>";} ?></span><br><span>Event Location: <?= $row['event_location'] ?></span></p>
							</div>
