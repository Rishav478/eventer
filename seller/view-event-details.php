              ...
              <div class="card ">
                ...
                <hr>
                    <div class="table-responsive" style="padding: 0px 10px;">
                        <h4>Registered User for this Event <span style="float: right; padding-right: 20px;"><h6><a href="view-all-referrals-event.php?name=<?= $getRows['paralLink'] ?>">View Referrals</a></h6></span></h4>
