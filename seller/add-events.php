                      ...
                      <div class="alert-body">
                        ...
                        <form method="POST" enctype="multipart/form-data">
                          ...
                          <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                              <label class="custom-switch">
                                <input type="radio" onclick="" name="virtual_event" id="" value="yes" class="custom-switch-input" required>
                                <span class="custom-switch-indicator"></span>
                                <span class="custom-switch-description">Virtual</span>
                              </label>
                              <label class="custom-switch">
                                <input type="radio" onclick="" name="virtual_event" id="" value="no" class="custom-switch-input" required>
                                <span class="custom-switch-indicator"></span>
    ...
    if (in_array($fileActualExt, $allowed)) {
      if ($fileError === 0) {
        if ($fileSize < 5000000) {
          ...
          $insert = "INSERT into event (event_name,event_category,event_price,event_details,event_startDate,event_endDate,event_regEndDate,event_banner,event_location,event_tags,paralLink,sellerId,virtual_event) values ('$event_name','$event_category','$event_price','$event_details','$event_startDate','$event_endDate','$event_regEndDate','$fileNameNew','$event_location','$event_tags','$event_name_url','$id','$virtual_event')";
