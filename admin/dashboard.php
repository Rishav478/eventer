      ...
      <div class="main-content">
        ...
        ?>
                      <tr>
                        ...
                        <td>
                          <a>
                            <img alt="image" src="../seller/assets/uploads/event-banner/<?= $rowsEv['event_banner'] ?>" class="rounded-rectangle" width="100" height="80" 
                                            data-toggle="title" title="">
                          </a>
                        </td>
                        <td><?= $rowsEv['event_name'] ?>
                          <div class="table-links">
                            <a href="view-event-details.php?name=<?= $rowsEv['paralLink'] ?>" target="_blank">View</a>
                        ...
                        <td><div style="text-transform: uppercase;" class="badge <?= $val1 ?>"><?= $rowsEv['event_status'] ?></div></td>
                      </tr>
                <?php } ?>
                    </table>
                  </div>
